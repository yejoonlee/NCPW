...
import typing as tp
from key.API_pinata import PinataKey
...
pinata_api_key, pinata_secret_api_key = PinataKey().get_keys()
...
class PinataPy:
    ...
    def pin_file_to_ipfs(self, paths_to_file: tp.List[str], options: tp.Optional[OptionsDict] = None) -> ResponsePayload:
        """
        ...
        files = [("file",(file, open(file, "rb"))) for file in paths_to_file]
